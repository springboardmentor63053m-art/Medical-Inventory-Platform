...
public class PostgreSQLSchemaInitializer {
    ...
    public PostgreSQLSchemaInitializer(DataSource dataSource) {
    ...
    public void initializeTables() {
        ...
        try (Connection conn = dataSource.getConnection()) {
            ...
            log.info("Database Product Name detected: {}", dbName);
            if (dbName != null) {
            ...
            log.warn("Could not determine database product name, assuming default PostgreSQL: {}", e.getMessage());
        }
