...
public class MedicineController {
    ...
    @GetMapping
    public ResponseEntity<List<Medicine>> getAll() { return ResponseEntity.ok(service.findAll()); }

    @GetMapping("/{id}")
    public ResponseEntity<Medicine> getById(@PathVariable Long id) { return ResponseEntity.ok(service.findById(id)); }

    @PostMapping
    public ResponseEntity<Medicine> create(@RequestBody Medicine entity) { return ResponseEntity.ok(service.save(entity)); }
